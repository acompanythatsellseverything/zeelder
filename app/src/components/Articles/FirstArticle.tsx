...
export default function FirstArticle() {
	return (
		<>
			<Container
				className={`relative mt-[50px] md:pb-[80px] bg-article-1-bg bg-no-repeat 
				bg-mob-right-center md:bg-lap-right-center md:bg-center-right 
				lg:bg-right-top bg-55 md:bg-60 min-[1424px]:bg-65 `}
			>
				<article>
					<ArticleScroll title='01' coloredLineHeight='8rem' />
					<div>
						<ArticleTitle className='max-w-xl'>
							Order custom parts online, get them manufactured and shipped after
							24 hours
						</ArticleTitle>
						<ArticleSubTitle>
						...
						<div className={'mt-5 max-w-2xl hidden md:block'}>
							<UploadCADForm />
						</div>
					</div>
				</article>
			</Container>
			<Container className={'mt-5 max-w-2xl block md:hidden pb-[80px] pt-0'}>
				<UploadCADForm />
			</Container>
		</>
	);
